...
exports.parsePngFiles = void 0;
var token_types_1 = require("../types/token.types");
var path_1 = require("path");
var fs_1 = require("fs");
function parsePngFiles(files) {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, {
                    categories: categoryNames.map(function (name) {
                        return {
                            name: name || 'Images',
                            presenter: token_types_1.TokenPresenter.IMAGE,
...
exports.parsePngFiles = parsePngFiles;
function determineTokens(files) {
    ...
    return files
        .map(function (file) {
        var path = (0, path_1.relative)(process.cwd(), file.filename);
        return {
            name: (0, path_1.basename)(file.filename, (0, path_1.extname)(file.filename)),
            description: path,
            categoryName: 'Images',
            presenter: token_types_1.TokenPresenter.IMAGE,
            rawValue: path,
            sourceType: token_types_1.TokenSourceType.IMAGE,
...
function toBase64(filePath) {
    // read binary data
    var bitmap = (0, fs_1.readFileSync)(filePath);
